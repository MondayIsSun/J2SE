package xmlOperation.imoocXML_write.A_sax_create;
...
import xmlOperation.imoocXML_write.entity.Book;
...
public class SAXTestCreate {
	...
	public void createXML() {
		...
		try {
			...
			handler.startElement("", "", "bookstore", attr);// ---> 因为有些节点我们可能并不需要为他生成属性的，所以我们使用attr来灵活地设置节点的属性
